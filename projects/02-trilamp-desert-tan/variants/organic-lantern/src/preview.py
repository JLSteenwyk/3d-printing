...
cap.apply_transform(trimesh.transformations.rotation_matrix(np.pi,[1,0,0]));cap.apply_translation([0,0,212])
shade=trimesh.util.concatenate([shade,cap])
...
fig.text(.07,.937,'ORGANIC LANTERN',fontsize=28,fontweight='bold',color='#40392c')
fig.text(.07,.895,'Bowed silhouette · flowing shallow waves · varied light openings',fontsize=13,color='#766a55')
