...
def cap():
 roof=M.Manifold.revolve(M.CrossSection([[(0,0),(42,0),(42.5,.5),(42.5,1.5),(42,2),(0,2)]]),256)
...
def package():
 ...
 prepare_studio.package('TriLamp_Soft_Spiral_Cap_P2S.3mf',['cap'],[(128,128)],title='Soft Spiral — matching vented cap',description='Independently designed removable cap with curved vents for the Soft Spiral shade.')
 ...
 prepare_studio.package('TriLamp_Soft_Spiral_Full_Set_P2S.3mf',['shade','cap','stand_tall','stand_base','stand_collar'],[(73,128),(178,128),(469.2,101),(375.2,120),(422.2,211)],plate_ids=[1,1,2,2,2],title='Soft Spiral — full tall lamp set',description='Soft Spiral shade and matching cap, plus original TriLamp tall stand parts by XYZilla. Personal local set.')
